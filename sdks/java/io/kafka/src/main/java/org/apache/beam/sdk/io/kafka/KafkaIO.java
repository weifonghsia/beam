 ...
 *
 * <p>For a given kafka bootstrap_server, KafkaIO is also able to detect and read from available
 * {@link TopicPartition} dynamically and stop reading from un. KafkaIO uses {@link
 ...
 * </ul>
 *
 * <p>Within providing {@code checkStopReadingFn}, there are 2 more cases that dynamic read can
 * handle:
 *
 * <ul>
 ...
 * </ul>
 *
 * <p>Race conditions may happen under 2 supported cases:
 *
 * <ul>
 ...
 * </ul>
 *
 * <p>When race condition happens, it will result in the stopped/removed TopicPartition failing to
 * be emitted to ReadFromKafkaDoFn again. Or ReadFromKafkaDoFn will output replicated records. The
 ...
 * </ul>
 *
 * <p>Another race condition example for producing duplicate records:
 *
 * <ul>
 ...
 * </ul>
 *
 * <p>For more design details, please refer to
 ...
 *
 * <p>{@link ReadSourceDescriptors} is the {@link PTransform} that takes a PCollection of {@link
 ...
 * }</pre>
 *
 * <p>Note that the {@code bootstrapServers} can also be populated from the {@link
...
public class KafkaIO {
   ...
   * }</pre>
   *
   * <p>. Note that this expansion is not supported when running with x-lang on Dataflow.
   */
  @Experimental(Kind.PORTABILITY)
  @AutoValue
  @AutoValue.CopyAnnotations
